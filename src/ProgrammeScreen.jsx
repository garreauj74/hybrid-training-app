...
import { TYPE_COLORS, SECTION_ICONS } from ‘./data.js’;

export default function ProgrammeScreen({ activeWeek, setActiveWeek, activeDay, setActiveDay, isMobile, activePhase, setActivePhase, currentWeekNotes, currentDays, currentGetWeekSets }) {
